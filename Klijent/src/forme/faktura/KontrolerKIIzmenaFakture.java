 ...
 * @author Jelena
 */
public class KontrolerKIIzmenaFakture {

    static void izmeniFakturu(Faktura faktura, FmUnosFakture aThis, JTextField txtBrojFakture, JTextField txtBrojOtpremnice,
