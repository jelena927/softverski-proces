 ...
 * @author Jelena
 */
public class SacuvajFakturuSaStavkama <T extends OpstiDomenskiObjekat> extends OpstaSistemskaOperacija {

    public SacuvajFakturuSaStavkama(T odo) {
        super(odo);
    }
    ...
    private boolean preduslov() throws Exception {
        return !(dbbr.vratiLogickuVrednostAtributa("obradjena", odo)
                || dbbr.vratiLogickuVrednostAtributa("stornirana", odo));
    }
}
